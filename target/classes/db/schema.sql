-- 创建数据库
CREATE DATABASE IF NOT EXISTS testlrc DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
('新闻查看', 'NEWS_VIEW', '新闻查看权限'),
('新闻发布', 'NEWS_PUBLISH', '新闻发布权限'),
('新闻编辑', 'NEWS_EDIT', '新闻编辑权限'),
('新闻删除', 'NEWS_DELETE', '新闻删除权限'),
('新闻审核', 'NEWS_AUDIT', '新闻审核权限'),
('会议查看', 'MEETING_VIEW', '会议查看权限'),
('会议发布', 'MEETING_PUBLISH', '会议发布权限'),
('会议编辑', 'MEETING_EDIT', '会议编辑权限'),
('会议删除', 'MEETING_DELETE', '会议删除权限'),
('会议审核', 'MEETING_AUDIT', '会议审核权限');
